...
(function () {
  ...
  const copy = {
    en: {
      ...
      "game.guide.year2.body": "Some deliverables need both you and your teammate. Call them back with Space when blockers split the team.",
    ...
    nl: {
      ...
      "game.guide.year2.body": "Sommige deliverables vragen zowel jou als je teamgenoot. Roep je teamgenoot terug met Space wanneer blockers het team splitsen.",
